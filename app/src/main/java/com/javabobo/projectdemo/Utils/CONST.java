...
public class CONST {
    ...
    public static String URL_INSERT_IMG_GALERY = "[URL_WEBSERVICE]/insert/insert_picture.php";
    public static String URL_GET_TASKS = "[URL_WEBSERVICE]/get_all_tasks.php";
}
